...
class ClienteDeCorreoTest {
	...
	protected ClienteDeCorreo cliente2;
	...
	@Test
	void cantidadDeEmailsEnCorreo() {
		// cliente con dos emails
		assertEquals(2, this.cliente.cantidadDeEmailsEnCorreo());
		// cliente sin emails
		assertEquals(0, this.cliente2.cantidadDeEmailsEnCorreo());
	}
